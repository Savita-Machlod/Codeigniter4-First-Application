        ...
        <form class="" action="/profile" method="post">
          ...
          <div class="row">
                  ...
                  <div class="col-12 col-sm-6">
                    ...
                    <input type="text" class="form-control" name="firstname" id="firstname" value="<?= set_value('firstname', $employee['firstname']) ?>">
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-sm-6">
                    ...
                    <input type="text" class="form-control" name="lastname" id="lastname" value="<?= set_value('lastname', $employee['lastname']) ?>">
                    </div>
                  </div>
